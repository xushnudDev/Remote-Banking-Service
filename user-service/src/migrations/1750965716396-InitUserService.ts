...
export class InitUserService1750965716396 implements MigrationInterface {
    name = 'InitUserService1750965716396'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_company" ("id" SERIAL NOT NULL, "company_id" integer NOT NULL, "role_id" integer NOT NULL, "user_id" integer NOT NULL, CONSTRAINT "PK_9e70b5f9d7095018e86970c7874" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user_company" ADD CONSTRAINT "FK_128160a3dfe4065da308a3cc6b3" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
